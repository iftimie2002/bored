...
const sanitizeB64 = _global.sanitizeB64 = function sanitizeB64(str) {
  if (typeof str !== 'string') throw new Error('Expected base64 string');
  return str.replace(/\s+/g, '');
};

const validateB64String = _global.validateB64String = function validateB64String(str, label) {
...
const parseB64WordArray = _global.parseB64WordArray = function parseB64WordArray(str, label) {
